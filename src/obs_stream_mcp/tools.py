...
TOOLS: list[Tool] = [
    ...
    Tool(
        name="obs_add_source",
        description="Add a new source (input) to a scene. Common source_type values: image_source, color_source_v3, browser_source, ffmpeg_source, text_gdiplus_v3, monitor_capture, window_capture, game_capture, dshow_input.",
